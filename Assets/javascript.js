...
$(document).ready(function () {
  ...
  $(".form-inline").on("submit", function (event) {
    ...
    // HOOKING ONTO THE UL ITEM
    savedCitiesEl.append($(`<li class="list-group-item city-button my-1">${searchedCity}</li>`));

    // HOOKING ONTO A ELEMENT
    // savedCitiesEl.append($(`<a class="city-button list-group-item list-group-item-action ">${searchedCity}</a>`));
  });

  /////////////event listener for clicking on a city button////////////////////////
  $(".city-button").on("click", "li", function (event) {
